...
<h5 class="over-title margin-bottom-15"><span class="text-bold">Buscar paciente por nombre/ número de cedula / número del documento</span>
...
$sql=mysqli_query($con,"select * from tblpatient where PatientName like '%$sdata%'|| PatientContno like '%$sdata%' || cedula like '%$sdata%'");
