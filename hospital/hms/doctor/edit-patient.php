...
<div class="row">
<div class="col-sm-8">
<h3><strong>DOCTOR | EDITAR PACIENTE</strong> </h3>	
</div>
<ol class="breadcrumb">
<li>
<span>Paciente</span>
...
<input type="number" name="patcontact" class="form-control" readonly='true' value="<?php  echo $row['PatientContno'];?>" required="true" maxlength="10" pattern="[0-9]+" >
</div>
<div class="form-group">
<label for="fess">
Email del paciente
</label>
<input type="email" id="patemail" name="patemail" class="form-control" readonly='true' value="<?php  echo $row['PatientEmail'];?>" >
...
Fecha de salida
	...
	<input type="date" name="fsalida"  class="form-control" readonly='true' required="true"  value="<?php  echo $row['fsalida'];?>">

<div class="form-group">
<label for="fsalida">
Fecha Nacimiento
</label>
	<input type="date" name="fnacimiento"  class="form-control" readonly='true' required="true"  value="<?php  echo $row['fnacimiento'];?>">
